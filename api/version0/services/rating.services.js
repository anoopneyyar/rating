...
//Get feedback by entity id
exports.findfeedbackById = async (entityId) => {
  try {
    let RatingResponse = await Ratings.find({entityID:entityId});
...
//Get rating by entity id


exports.findRatingByentity = async (entityID) => {
  try {
